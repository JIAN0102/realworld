...
<template>
  <form class="border border-[#e5e5e5] rounded">
    <textarea
      ...
      class="block w-full p-5 text-[#55595c] leading-tight bg-white rounded outline-none disabled:bg-[#eceeef] disabled:pointer-events-none"
    ...
    >
      ...
      <button
        class="inline-block px-2 py-1 text-sm text-white bg-primary rounded hover:bg-primary-dark disabled:pointer-events-none disabled:opacity-60"
        type="button"
